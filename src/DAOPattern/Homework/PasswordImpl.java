...
public class PasswordImpl implements PasswordDAO {
    final static String DB_FILE_NAME = "Login.db";
    final static String DB_TABLE_NAME = "'Id/Password'";
    ...
    public void update(PasswordInfo p) {
        PasswordInfo person = findByKey(p.getUrl());
        if (person != null) {
            try {
