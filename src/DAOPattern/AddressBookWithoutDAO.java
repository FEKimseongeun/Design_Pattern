...
// create table
            ...
            statement.executeUpdate( //executeUpdate는 정수값을 반환함 execute과 거의 같게 사용됨
            ...
            rs = statement.executeQuery( //executeQuery는 위에 ResultSet 의 결과를 받는거라고 보면됨 결과물을 받고싶을때 쓰는 거임
                    //그래서 얘는 주로 SELECT문만 거의 사용한다고 보면 됨
            ...
            statement.execute( //execute는 true false로 반환함
